...
/*   Updated: 2019/11/21 23:34:55 by nbousset         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
** Maybe simplify this (one struct)
...
int						ft_list_add_front(t_list *list, t_list_elem *new);
int						ft_list_add_back(t_list *list, t_list_elem *new);
...
int						ft_list_insert_at(t_list *list, const void *value,
													int index, ssize_t size);
int						ft_list_add(t_list *list, const void *value, ssize_t size);
...
int						ft_trie_contains(t_trie *trie, char *word);
